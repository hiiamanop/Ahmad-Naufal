...
<body>
  ...
  <div class="container mt-4">
    <!-- kondisi saat menu di klik -->
    <?php
    // jika ada parameter page (penamaan parameter page ada di atas di menu menu di hrefnya)
    if (isset($_GET['page'])) {
      $page = $_GET['page'];
      $action = @$_GET['action'];
      // panggil file sesuai isi data yang ada di parameter page
      ...
      // manggil file transaksi/index.php\
      include __DIR__ . '/views/transaksi/index.php';
    } else {
      // maka kita panggil file dashboard/index.php seagau halaman utama
