...
// buat objek untuk merealisasikan class
$mahasiswa = new Inputan();

// buat variable untk menampung dungsi getInputan($Inputan) yang ada du class Inputan
